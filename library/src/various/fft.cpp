 ...
 */
	...
	vector	= (std::complex<float> *) FFTW_MALLOC
	                        (sizeof (std::complex<float>) * fft_size);
	memset (vector, 0, sizeof (std::complex<float>) * fft_size);
...
std::complex<float>	*v = (std::complex<float> *)
	            alloca (fft_size * sizeof (std::complex<float>));
